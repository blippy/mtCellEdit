	...
	)
{
	...
	case mtPixy::File::BMP:
		return mtKit::set_filename_extension ( filename, "bmp", NULL,
			NULL );
	...
	case mtPixy::File::JPEG:
		return mtKit::set_filename_extension ( filename, "jpeg", "jpg",
			NULL );

	case mtPixy::File::GIF:
		return mtKit::set_filename_extension ( filename, "gif", NULL,
			NULL );

	case mtPixy::File::GPL:
		return mtKit::set_filename_extension ( filename, "gpl", NULL,
			NULL );
