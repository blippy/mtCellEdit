	...
	)
{
	...
	case CUI_SHEET_EXPORT_EPS:
		return mtKit::set_filename_extension ( filename, "eps",
			NULL, ext_multi );

	case CUI_SHEET_EXPORT_HTML:
		return mtKit::set_filename_extension ( filename, "html",
			NULL, ext_multi );

	case CUI_SHEET_EXPORT_PDF:
	case CUI_SHEET_EXPORT_PDF_PAGED:
		return mtKit::set_filename_extension ( filename, "pdf",
			NULL, ext_multi );

	case CUI_SHEET_EXPORT_PNG:
		return mtKit::set_filename_extension ( filename, "png",
			NULL, ext_multi );

	case CUI_SHEET_EXPORT_PS:
		return mtKit::set_filename_extension ( filename, "ps",
			NULL, ext_multi );

	case CUI_SHEET_EXPORT_SVG:
		return mtKit::set_filename_extension ( filename, "svg",
			NULL, ext_multi );

	case CUI_SHEET_EXPORT_TSV:
	case CUI_SHEET_EXPORT_TSV_QUOTED:
		return mtKit::set_filename_extension ( filename, "tsv",
			NULL, ext_multi );
	...
	)
{
	...
	case CED_FILE_TYPE_TSV_CONTENT_GZ:
	case CED_FILE_TYPE_TSV_VALUE_GZ:
		return mtKit::set_filename_extension ( filename, "tsv.gz",
			NULL, ext_multi );
	...
	case CED_FILE_TYPE_CSV_VALUE:
	case CED_FILE_TYPE_CSV_VALUE_NOQ:
		return mtKit::set_filename_extension ( filename, "csv",
			NULL, ext_multi );

	case CED_FILE_TYPE_LEDGER:
	case CED_FILE_TYPE_LEDGER_VAL:
		return mtKit::set_filename_extension ( filename, "ledger",
			NULL, ext_multi );

	case CED_FILE_TYPE_LEDGER_GZ:
	case CED_FILE_TYPE_LEDGER_VAL_GZ:
		return mtKit::set_filename_extension ( filename, "ledger.gz",
			NULL, ext_multi );

	case CED_FILE_TYPE_TSV_BOOK:
	case CED_FILE_TYPE_TSV_VAL_BOOK:
		return mtKit::set_filename_extension ( filename, "tsv.zip",
			"ced", ext_multi );

	case CED_FILE_TYPE_LEDGER_BOOK:
	case CED_FILE_TYPE_LEDGER_VAL_BOOK:
		return mtKit::set_filename_extension ( filename, "ledger.zip",
			"ced", ext_multi );
